...
int main() {
    while (true) {
        ...
        // Debugging output
        std::cout << "==================================================\n\n";
        std::cout << "-  20 Lap stint data from .ini: \n";
        std::cout << "      LF_scuff: " << iniData["LF_scuff"] << std::endl;
        std::cout << "      LR_scuff: " << iniData["LR_scuff"] << std::endl;
        std::cout << "      RF_scuff: " << iniData["RF_scuff"] << std::endl;
        std::cout << "      RR_scuff: " << iniData["RR_scuff"] << std::endl;
        std::cout << " \n";
        ...
        std::cout << "-  Estimated tread after " << laps << " laps: \n";
